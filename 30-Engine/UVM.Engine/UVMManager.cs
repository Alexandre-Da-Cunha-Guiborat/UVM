    ...
    public static class UVMManager
    {
                ...
                List<I_VersionableFile> modifiedFiles)
        {
            ...
            if (childrenTree is null)
            {
                ...
                UVMLogger.AddLog(E_LogLevel.INFO, titleNoFilesToUpdate, messageNoFilesToUpdate);
            ...
            UVMLogger.AddLogListVF(E_LogLevel.INFO, title, message, filesToUpdate);
            ...
            List<I_VersionableFile> vfLeafs)
        {
            ...
            UVMLogger.AddLogListVF(E_LogLevel.INFO, title, message, parentTree);
            ...
            UInt32 maxIter)
        {
            ...
            if (nbIter > maxIter)
            {
                ...
                UVMLogger.AddLog(E_LogLevel.ERROR, errTitle, errMessage);
                return [];
            }
            ...
            if (filesToUpdate.Any())
            {
                ...
                UVMLogger.AddLogListVF(E_LogLevel.TRACE, title, message, filesToUpdate);
            ...
            UInt32 maxIter)
        {
            ...
            if (parentFiles.Any())
            {
                ...
                String message = "Newly added files to update equals";
                UVMLogger.AddLogListVF(E_LogLevel.TRACE, title, message, parentFiles);
