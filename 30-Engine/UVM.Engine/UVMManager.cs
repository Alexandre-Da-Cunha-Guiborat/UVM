    ...
    public static class UVMManager
    {
                ...
                List<I_VersionableFile> modifiedFiles)
        {
            ...
            if (childrenTree is null)
            {
                ...
                UVMLogger.AddLog(ADCGLogLevelType.INFO, titleNoFilesToUpdate, messageNoFilesToUpdate);
            ...
            UVMLogger.AddLogListVF(ADCGLogLevelType.INFO, title, message, filesToUpdate);
            ...
            List<I_VersionableFile> vfLeafs)
        {
            ...
            UVMLogger.AddLogListVF(ADCGLogLevelType.INFO, title, message, parentTree);
            ...
            UInt32 maxIter)
        {
            ...
            if (nbIter > maxIter)
            {
                ...
                UVMLogger.AddLog(ADCGLogLevelType.ERROR, errTitle, errMessage);
                return [];
            }
            ...
            if (filesToUpdate.Any())
            {
                ...
                UVMLogger.AddLogListVF(ADCGLogLevelType.TRACE, title, message, filesToUpdate);
            ...
            UInt32 maxIter)
        {
            ...
            if (parentFiles.Any())
            {
                ...
                String message = "Newly added files to update equals";
                UVMLogger.AddLogListVF(ADCGLogLevelType.TRACE, title, message, parentFiles);
