...
MODE_RELEASE = True
RPOJECT_NAME = "UVM.Service"
CSPROJFOLDER_NAME = f"../40-Service/{RPOJECT_NAME}"
CSPROJ_NAME = f"{RPOJECT_NAME}.csproj"

NUGET_CONFIG_FILE_NAME = "../nuget.config"
NUGET_OUTPUTFOLDER_DEBUG = f"/UVM/Packages/Debug/{RPOJECT_NAME}"
NUGET_OUTPUTFOLDER_RELEASE = f"/UVM/Packages/Release/{RPOJECT_NAME}"
