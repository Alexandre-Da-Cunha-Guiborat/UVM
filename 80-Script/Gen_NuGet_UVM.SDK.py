...
MODE_RELEASE = True
CSPROJFOLDER_NAME = "../50-App/UVM.SDK"
CSPROJ_NAME = "UVM.SDK.csproj"
NUGET_CONFIG_FILE_NAME = "../nuget.config"
NUGET_OUTPUTFOLDER_DEBUG = "/UVM/packages/UVM.SDK"
NUGET_OUTPUTFOLDER_RELEASE = "/UVM/packages/UVM.SDK"
