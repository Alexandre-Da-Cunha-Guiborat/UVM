...
MODE_RELEASE = True
CSPROJFOLDER_NAME = "../30-Engine/UVM.Engine"
CSPROJ_NAME = "UVM.Engine.csproj"
NUGET_CONFIG_FILE_NAME = "../nuget.config"
NUGET_OUTPUTFOLDER_DEBUG = "/UVM/packages/UVM.Engine"
NUGET_OUTPUTFOLDER_RELEASE = "/UVM/packages/UVM.Engine"
