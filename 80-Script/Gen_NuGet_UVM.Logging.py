...
MODE_RELEASE = True
CSPROJFOLDER_NAME = "../10-Common/UVM.Logging"
CSPROJ_NAME = "UVM.Logging.csproj"
NUGET_CONFIG_FILE_NAME = "../nuget.config"
NUGET_OUTPUTFOLDER_DEBUG = "/UVM/packages/UVM.Logging"
NUGET_OUTPUTFOLDER_RELEASE = "/UVM/packages/UVM.Logging"
