...
CMD_PACK_DEBUG = "dotnet pack --configuration Debug --version-suffix \"DEBUG\""
CMD_PACK_RELEASE = "dotnet pack --configuration Release"

MODE_RELEASE = True
CSPROJFOLDER_NAME = "../10-Common/UVM.Interface"
CSPROJ_NAME = "UVM.Interface.csproj"
NUGET_CONFIG_FILE_NAME = "../nuget.config"
NUGET_OUTPUTFOLDER_DEBUG = "/UVM/packages/UVM.Interface"
NUGET_OUTPUTFOLDER_RELEASE = "/UVM/packages/UVM.Interface"
