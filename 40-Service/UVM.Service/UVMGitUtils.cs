    ...
    public static class UVMGitUtils
    {
        ...
        public static Boolean IsRebaseNeeded(String gitDirPath, String branchName, String commitIdRef, String commitId)
        {
            ...
            if (currentBranch is null)
            {
                ...
                UVMLogger.AddLog(E_LogLevel.ERROR, titleNoCurrentBranch, messageNoCurrentBranch);
            ...
            if (refCommit is null || commit is null)
            {
                ...
                UVMLogger.AddLog(E_LogLevel.ERROR, titleCommitNull, messageCommitNull);
            ...
            else
            {
                ...
                if (commonAncestor is null)
                {
                    ...
                    UVMLogger.AddLog(E_LogLevel.INFO, titleAncestor, messageAncestor);
            ...
            List<String> fExtensions)
        {
            ...
            if (modifiedFilesExts.Any())
            {
                foreach (I_VersionableFile vf in vfPool)
                {
                    ...
                    if (vfFileInfo.DirectoryName is null)
                    {
                        ...
                        UVMLogger.AddLog(E_LogLevel.ERROR, errTitle, errLog);
            ...
            UVMLogger.AddLogListVF(E_LogLevel.INFO, title, preface, vfToUpdate);
            ...
            List<String> commitIds)
        {
            ...
            UVMLogger.AddLogListVF(E_LogLevel.INFO, title, preface, vfAheadOfGit);
            ...
            List<String> fExtensions)
        {
            ...
            UVMLogger.AddLogListVF(E_LogLevel.INFO, title, preface, vfAllKind);
        ...
        private static List<String> GetGitDiffCommitWithCommitRef(String gitDirPath, String commitIdRef, String commitId)
        {
            if (IsGitDirectory(gitDirPath) is false)
            {
                ...
                UVMLogger.AddLog(E_LogLevel.INFO, titleNotGitRepo, messageNotGitRepo);
            ...
            UVMLogger.AddLog(E_LogLevel.INFO, titleNoChange, message);
