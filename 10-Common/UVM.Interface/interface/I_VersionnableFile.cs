...
namespace UVM.Interface
{
    ...
    public interface I_VersionnableFile
    {
        ...
        /// </summary>
        /// <param name="vfPool">List of all <see cref="I_VersionnableFile"/> that could be a dependence of this <see cref="I_VersionnableFile"/>.</param>
        ...
        public abstract List<I_VersionnableFile> ComputeDependencies(List<I_VersionnableFile> vfPool);
        ...
        public abstract bool DumpFile(string outputPath);
